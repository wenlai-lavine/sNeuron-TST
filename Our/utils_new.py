...
class GreedySearchDecoderOnlyOutput(ModelOutput):
    ...
    total_distance_list: Optional[List] = None
    ...
    def dola_greedy_decode(
        ...
        **model_kwargs,
        ...
        while True:
            ...
            ## store the distance we have now
            total_distance_list.append([round(i * pow(10, 5), 2) for i in js_divs.tolist()])
        ...
        if return_dict_in_generate:
            if self.config.is_encoder_decoder:
                ...
                return GreedySearchDecoderOnlyOutput(
                    ...
                    total_distance_list = total_distance_list,
                )
        else:
            return input_ids
